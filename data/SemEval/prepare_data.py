...
if __name__ == '__main__':
    ...
    infiles = [ srcdir + 'SemEval_train.txt', srcdir + 'SemEval_dev.txt', srcdir + 'SemEval_test.txt']
    ...
    fout = open(dstdir + 'corpus_preprocessed.txt', 'w', encoding='utf-8')
    ...
    with open(triletter_dict_output, 'w', encoding='utf-8') as f:
        for tri_id, tric in triletter_dict.items():
            print(f, tri_id, tric, file=f)
    with open(word_triletter_output, 'w', encoding='utf-8') as f:
