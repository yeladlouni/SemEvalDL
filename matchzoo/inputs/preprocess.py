...
class Preprocess(object):
    ...
    def __init__(self,
        ...
        self._word_filter_config = { 'enable': False, 'stop_words': stopwords.words('arabic'),
...
def cal_hist(t1_rep, t2_rep, qnum, hist_size):
    #qnum = len(t1_rep)
    #print('t1_rep ', t1_rep.shape, ' t2_rep ', t2_rep.shape)
    ...
    for (i,j), v in np.ndenumerate(mm):
        ...
        #print('mhist:', mhist.shape, 'i:', i, 'j:', j, 'v:', v, 'vid:', vid)
        #print()
        mhist[i][vid] += 1.
    mhist += 1.
